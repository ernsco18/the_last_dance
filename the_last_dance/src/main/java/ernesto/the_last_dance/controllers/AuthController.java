...
import ernesto.the_last_dance.exceptions.ValidationException;
...
public class AuthController {
    ...
    public Utente registrazione(@RequestBody @Validated UtenteDTO body, BindingResult validationResults){
